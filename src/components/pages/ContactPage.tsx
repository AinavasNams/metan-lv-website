              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      {t('contact.info.address.value', 'ул. Бривибас 100, Рига, Латвия, LV-1001')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      <a href="tel:+37120000000" className="hover:text-blue-600 transition-colors">
                        +371 2000 0000
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      <a href="mailto:info@ch4-future.com" className="hover:text-blue-600 transition-colors">
                        info@ch4-future.com
                      </a>
                    </p>
                  </div>
